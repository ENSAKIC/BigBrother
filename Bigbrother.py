...
class BBMain ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.M_Pic_Frame = wx.StaticBitmap( self, wx.ID_ANY, wx.NullBitmap, wx.Point( 20,20 ), wx.Size( 500,200 ), 0 )
		...
		self.M_Pic_Picker = wx.FilePickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, 0)
		bSizer5.Add( self.M_Pic_Picker, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		
		bSizer4.Add( bSizer5, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.TOP|wx.EXPAND, 50 )
